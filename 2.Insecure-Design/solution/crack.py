...
if __name__ == "__main__":
    base64_encrypted = "W79LCtMGL5E="
    base64_to_decrypt = "-0kCPzQQP-krgoBgN-K7Xw=="

    first_4 = "NEBY"
    plain_text = "Asdf1@"
    des_encrypted = urlsafe_b64decode(base64_encrypted)
    des_to_decrypt = urlsafe_b64decode(base64_to_decrypt)
    crack(first_4, plain_text, des_encrypted, des_to_decrypt)